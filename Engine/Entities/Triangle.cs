...
public class Triangle : Mesh
{
    ...
    public Triangle(Vec3 position) : base(verticeCount: 3, position: position, indices: new uint[3] { 0, 1, 2 })
    {
    ...
    public Triangle(Vec3[] vertices) : base(verticeCount: 3, position: Vec3.Zero, indices: new uint[3] { 0, 1, 2 })
    {
        for (int i = 0; i < 3; i++)
        {
